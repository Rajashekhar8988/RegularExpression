...
public class RegularExpression {
	...
	public static void main(String[] args) {
		...
		System.out.println("Enter your first name start with capital and has minimum 3 characters :");
		String firstName=name.next();
		System.out.println("Enter your last name start with capital and has minimum 3 characters :");
